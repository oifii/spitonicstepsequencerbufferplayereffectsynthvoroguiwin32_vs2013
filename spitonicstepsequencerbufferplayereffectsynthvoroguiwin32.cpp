...
#include "stdafx.h"
#include "spitonicstepsequencerbufferplayereffectsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicstepsequencerbufferplayereffectsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicstepsequencerbufferplayereffectsynthvoroguiwin32class"};				// the main window class name
